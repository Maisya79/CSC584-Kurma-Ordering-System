       		...
       		<div class="formcontainer">
  				<form action="ProductUpdateController" method=post enctype="multipart/form-data">
  					<div class="formrow">
      					...
      					<div class="col-75">
        				<input type="text" id="productid" name="productid" value="<c:out value="${prod.product_ID}"/>" readonly>
      					</div>
    				</div>
    				<div class="formrow">
      					<div class="col-25">
     					...
     					<div class="col-75">
       	 					<input type="text" id="productname" name="productname" value="<c:out value="${prod.product_name}"/>" >
      					</div>
    				</div>
    				<div class="formrow">
      					<div class="col-25">
      					...
      					<div class="col-75">
        					<input type="text" id="productprice" name="productprice" value="<c:out value="${prod.product_price}"/>">
      					</div>
    				</div>
    				<div class="formrow">
      					<div class="col-25">
    				...
    				<div class="formrow">
      					...
      					<div class="col-75">
        				<input type="number" id="productstock" name="productstock" value="<c:out value="${prod.product_stock}"/>" >
      					</div>
    				</div>
    				...
    				<div class="formrow">
      					...
      					<div class="col-75">
        				Select file to edit image:<br><input type="file" name="prodimg">
      					</div>
    				</div>
    				<div class="formrow">
