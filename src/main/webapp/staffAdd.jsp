...
<div class="formcontainer">
  <form action="StaffAddController" method=post>
    <div class="formrow">
      <div class="col-25">
    ...
    <div class="formrow">
      ...
      <div class="col-75">
        <input type="email" id="staffemail" name="staffemail" placeholder = "Staff Email..." >
      </div>
    </div>
    <div class="formrow">
      <div class="col-25">
      ...
      <div class="col-75">
        <input type="text" id="staffphoneno" name="staffphoneno" placeholder = "Staff Phone no..." >
      </div>
    </div>
    <div class="formrow">
      <div class="col-25">
      ...
      <div class="col-75">
        <input type="password" id="staffpassword" name="staffpassword" placeholder = "Staff Password..." >
      </div>
    </div>
    <div class="formrow">
