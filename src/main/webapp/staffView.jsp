          ...
          <div class="col-md-6">
            <div class="right-image">
              <a class="fcc-btn" href="StaffListController">Back</a>
				...
				<h5>Staff ID: </h5>
				<div class="thedetails"><c:out value="${stf.staff_ID}"/></div>
            	<h5>Name: </h5>
            	<div class="thedetails"><c:out value="${stf.staff_name}"/></div>
            	<h5>Email: </h5>
            	<div class="thedetails"><c:out value="${stf.staff_email}"/></div>
            	<h5>Phone No: </h5>
            	<div class="thedetails"><c:out value="${stf.staff_phone_no}"/></div>
				</div>
