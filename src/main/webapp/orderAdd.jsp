     	...
     	<div class="col-md-12">
            <div class="section-heading">
     		...
     		<div class="col-md-6">
     			...
     			<a class="fcc-btn" href="CustomerOrderController">Back</a>
     			...
     			<div class="col-md-6">
            		<div class="left-content">
            			...
            			<input type="hidden" name="productid" value="<c:out value="${prod.product_ID}"/>">
              			<h3><c:out value="${prod.product_name}"/></h3>
              			<input type="hidden" name="productname" value="<c:out value="${prod.product_name}"/>">
              			<p>RM <c:out value="${prod.product_price}"/>
              			<input type="hidden" name="productprice" value="<c:out value="${prod.product_price}"/>">
              			<br><br>
              			<div class="howmany">
              			<input type="button" onclick="decrementValue()" value="-" />
              			<input type="text" id="quantity" name="quantity" value="0"/>
              			<input type="button" onclick="incrementValue()" value="+" /></p>
              			</div>
              			<br><br>
