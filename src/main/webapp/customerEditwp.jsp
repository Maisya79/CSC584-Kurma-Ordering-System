...
<div class="formcontainer">
  <form action="CustomerUpdateProfile" method=post>
    <div class="formrow">
      <div class="col-75">
        <input type="hidden" id="custid" name="custid" value="<c:out value="${cust.cust_ID}"/>" readonly>
      </div>
    </div>
    <div class="formrow">
      <div class="col-25">
      ...
      <div class="col-75">
        <input type="text" id="custname" name="custname" value="<c:out value="${cust.cust_name}"/>">
      </div>
    </div>
    <div class="formrow">
      <div class="col-25">
        <label for="custphoneno">Phone no</label>
      </div>
      <div class="col-75">
        <input type="text" id="custphoneno" name="custphoneno" value="<c:out value="${cust.cust_phone_no}"/>">
      </div>
    </div>
    <div class="formrow">
      <div class="col-25">
      ...
      <div class="col-75">
        <textarea name= "custaddress" placeholder="Address" id="custaddress"><c:out value="${cust.cust_address}"/></textarea>
      </div>
    </div>
    <div class="formrow">
      	<div class="col-25">
    ...
    <div class="formrow">
      ...
      <div class="col-75">
        <input type="custdob" id="custdob" name="custdob" value="<c:out value="${cust.cust_DOB}"/>">
      </div>
    </div>
    ...
    <div class="formrow">
      ...
      <div class="col-75">
        <input type="email" id="custemail" name="custemail" value="<c:out value="${cust.cust_email}"/>">
      </div>
    </div>
    
    <div class="formrow">
      <div class="col-25">
        <label for="custpassword">Enter account password for confirmation</label>
      </div>
      <div class="col-75">
       <input type="password" id="custpassword" name="custpassword" onkeyup='check();'>
      </div>
    </div>
    
    <div class="formrow">
      <div class="col-25">
        <label for="confirm">Enter account password again</label>
      </div>
      <div class="col-75">
